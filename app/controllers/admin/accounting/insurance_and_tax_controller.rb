class Admin::Accounting::InsuranceAndTaxController < Admin::BaseController
  # トップページ - 給与計算履歴と処理ボタン
  def index
  ...
  def execute_social_insurance_step1
    redirect_to social_insurance_step2_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_social_insurance_step2
    redirect_to social_insurance_step3_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_social_insurance_step3
    redirect_to social_insurance_step4_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_social_insurance_step4
    redirect_to social_insurance_step5_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_social_insurance_step5
    redirect_to social_insurance_step6_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_withholding_tax_step1
    redirect_to withholding_tax_step2_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_withholding_tax_step2
    redirect_to withholding_tax_step3_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_withholding_tax_step3
    redirect_to withholding_tax_step4_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_withholding_tax_step4
    redirect_to withholding_tax_step5_admin_accounting_insurance_and_tax_path(params[:id])
  end
  ...
  def execute_withholding_tax_step5
    redirect_to withholding_tax_step6_admin_accounting_insurance_and_tax_path(params[:id])
  end
